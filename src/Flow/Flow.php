...
class Flow implements Iterator
{
   ...
   * all of them.
   *
   * <p>This is done by replacing each value on the current iteration by the values generated by a new iterator returned
   * by a user-supplied function called for each of the original values.
   *
   * <p>This is equivalent to a `map($fn)->unfold()` operation.
   *
  ...
  function unfold ()
  {
    $this->setIterator (new UnfoldIterator ($this->getIterator ()));
    return $this;
  }
